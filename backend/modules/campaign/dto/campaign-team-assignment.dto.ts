...
export class CreateCampaignTeamAssignmentDto {
  ...
  @ApiProperty({ enum: CampaignAssignmentRole, example: CampaignAssignmentRole.WRITER })
...
export class UpdateCampaignTeamAssignmentDto {
  ...
  @ApiPropertyOptional({ enum: CampaignAssignmentRole, example: CampaignAssignmentRole.EDITOR })
  @IsOptional()
  @IsEnum(CampaignAssignmentRole)
  assignmentRole?: CampaignAssignmentRole;
