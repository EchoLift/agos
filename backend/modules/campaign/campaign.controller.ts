...
export class CampaignController {
  ...
  createPublishingSchedule(
    @Param("id") id: string,
    @Body() dto: CreatePublishingScheduleDto,
    @CurrentUser() user: IdentityContext,
  ) {
  ...
  updatePublishingSchedule(
    ...
    return this.campaignService.updatePublishingSchedule(
      id,
      scheduleId,
      dto,
      user,
  ...
  cancelPublishingSchedule(
    ...
    return this.campaignService.cancelPublishingSchedule(
      id,
      scheduleId,
      dto,
      user,
  ...
  markPublishingSchedulePublished(
    ...
    return this.campaignService.markPublishingSchedulePublished(
      id,
      scheduleId,
      dto,
      user,
  ...
  generatePublishingProduction(
    ...
    return this.campaignService.generatePublishingProduction(
      id,
      scheduleId,
      dto,
      user,
  ...
  @Post(":id/team")
  @ApiOperation({
    summary: "Assign a member to a structured campaign responsibility",
  })
  assignTeamMember(
    @Param("id") id: string,
    @Body() dto: CreateCampaignTeamAssignmentDto,
    @CurrentUser() user: IdentityContext,
  ) {
  ...
  updateTeamAssignment(
    ...
    return this.campaignService.updateTeamAssignment(
      id,
      assignmentId,
      dto,
      user,
