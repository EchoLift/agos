...
export const workflowTransitionRules: Record<ContentStage, ContentStage[]> = {
  ...
  [ContentStage.MANAGER_SCRIPT_REVIEW]: [ContentStage.SHOOT, ContentStage.EDITING],
  ...
  [ContentStage.MANAGER_EDIT_REVIEW]: [ContentStage.CLIENT_APPROVAL, ContentStage.ARCHIVED],
  [ContentStage.CLIENT_APPROVAL]: [ContentStage.SCHEDULED, ContentStage.ARCHIVED],
...
export function canTransition(fromStage: ContentStage | null | undefined, toStage: ContentStage): boolean {
  if (!fromStage) {
