...
export class CalendarController {
  ...
  @Get('events')
  @ApiOperation({ summary: 'Get role-aware calendar events for the active agency' })
  getEvents(@Query() query: CalendarEventsQueryDto, @CurrentUser() user: IdentityContext) {
